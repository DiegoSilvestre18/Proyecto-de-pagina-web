...
CREATE TABLE GAME_ACCOUNT (
    ...
    JUEGO VARCHAR(50) NOT NULL, -- 'VALORANT', 'DOTA2', 'LOL', 'CS2'
    ID_EXTERNO VARCHAR(100) NOT NULL, -- El ID único que use ese juego
    ID_VISIBLE VARCHAR(100), -- El Nickname
    
    RANGO_ACTUAL VARCHAR(50), 
    ES_RANGO_MANUAL BOOLEAN DEFAULT FALSE,
    
    -- AQUÍ GUARDAS CUALQUIER COSA RARA DEL FUTURO
