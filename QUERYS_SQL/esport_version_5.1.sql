...
CREATE TABLE SALA (
    ...
    -- NUEVAS COLUMNAS INTEGRADAS (Con comillas dobles para respetar mayúsculas)
...
CREATE TABLE PARTICIPANTE_SALA (
    ...
    -- Ampliado a VARCHAR(50) para permitir "ESPERANDO_DRAFT"
...
CREATE TABLE MOVIMIENTOS (
    ...
    CONSTRAINT CHK_MOVIMIENTO_ORIGEN CHECK (
        ...
        (RECARGA_ID IS NULL AND SALA_ID IS NULL AND RETIRO_ID IS NULL) -- <- PERMITE BONOS MANUALES
    )
);
...
-- ==========================================================
-- 6. ACTUALIZACIONES DE PRUEBA (Opcional)
-- Nota: Solo funcionará si ya existe una sala con SALA_ID = 17
-- ==========================================================
UPDATE sala 
